...
```
[NodeInterestRates.kt](https://github.com/corda/corda/blob/release/os/4.1/samples/irs-demo/cordapp/workflows-irs/src/main/kotlin/net.corda.irs/api/NodeInterestRates.kt)<div class="r3-o-note" role="alert"><span>Note: </span>
