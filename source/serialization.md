...
```
[ClientRpcTutorial.kt](https://github.com/corda/corda/blob/release/os/4.3/docs/source/example-code/src/main/kotlin/net/corda/docs/kotlin/ClientRpcTutorial.kt)<div class="r3-o-note" role="alert"><span>Note: </span>
